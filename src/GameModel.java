...
public class GameModel {
	...
	public void reinitializeSomme() {
		...
		for(int i = 0; i<getDigits().length(); i++) 
			cases.get(i).setDidCalculateSomme(false);
	 ...
	 * by setting all the cases state to true and by setting its attribute
	...
	public void blockCurrentSum() {
		for(int i=0; i<getDigits().length(); i++) {
			cases.get(i).setState(true);
			cases.get(i).setDidCalculateSomme(true);
		}
	}
